...
<Row className="rowS my-6">
  ...
  <Col md={3}>
    ...
    <Nav className="flex-column">
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Privacy</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Cookie Preferences</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Contact Us</Nav.Link>
    </Nav>
  </Col>
  ...
  <Col md={3}>
    ...
    <Nav className="flex-column">
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Audio Description</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Gift Cards</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Investor Relations</Nav.Link>
    </Nav>
  </Col>

  <Col md={3}>
  <Nav className="flex-column">
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Terms of Use</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Legal Notices</Nav.Link>
      <Nav.Link className="mb-2 p-0 text-muted" href="#">Information</Nav.Link>
    </Nav>
    </Col>  
</Row>
<Row className="rowS my-6">
  <Button size="sm" id="service" >Service Code </Button> 
</Row>
<Row className="rowS my-6">
  <p id="par">1977-2022 Netflix, Inc.</p>
</Row>
</div>
        </Container>
    )
